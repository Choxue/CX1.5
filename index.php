	...
	<body>
		...
		function callPlayer(frame_id, func, args) {
			...
			$(document).ready(function() {
				...
				$("#days").countdown("2016/09/29 14:00:00", function(event) {
				  $(this).text(event.strftime('%D'));
				});
				$("#hours").countdown("2016/09/29 14:00:00", function(event) {
				  $(this).text(event.strftime('%H'));
				});
				$("#minutes").countdown("2016/09/29 14:00:00", function(event) {
				  $(this).text(event.strftime('%M'));
				});
				$("#seconds").countdown("2016/09/29 14:00:00", function(event) {
